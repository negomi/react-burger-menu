...
describe('BurgerIcon component', () => {
  ...
  describe('visual icon', () => {
    ...
    it('has the correct styles', () => {
      expect(Object.keys(component.props.children[0].props.style)).to.have.length(6);
      expect(Object.keys(component.props.children[1].props.style)).to.have.length(6);
      expect(Object.keys(component.props.children[2].props.style)).to.have.length(6);
    });
  });

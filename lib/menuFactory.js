        ...
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            styles.svg && _react2['default'].createElement(
              'div',
              { className: ('bm-morph-shape ' + this.props.morphShapeClassName).trim(), style: this.getStyles('morphShape') },
              _react2['default'].createElement(
                'svg',
            ...
            _react2['default'].createElement(
              'div',
              { className: ('bm-menu ' + this.props.menuClassName).trim(), style: this.getStyles('menu') },
              _react2['default'].createElement(
                'nav',
                { className: ('bm-item-list ' + this.props.itemListClassName).trim(), style: this.getStyles('itemList') },

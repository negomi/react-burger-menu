  ...
  return _react2['default'].createClass({
    ...
    render: function render() {
      ...
      return _react2['default'].createElement(
        'div',
        null,
        _react2['default'].createElement('div', { id: 'bm-overlay', ref: 'overlay', onClick: this.toggleMenu, style: styles.overlay(this.getIsOpen()) }),
        _react2['default'].createElement(
          'div',
          { id: this.props.id, style: styles.menuWrap(this.getIsOpen()) },
          svg,
          _react2['default'].createElement(
            'div',
            { className: 'bm-menu', style: styles.menu(this.getIsOpen()) },
            _react2['default'].createElement(
              'nav',
          ...
          _react2['default'].createElement(
            'div',
            { style: styles.closeButton ? styles.closeButton(this.getIsOpen()) : {} },

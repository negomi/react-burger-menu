...
exports['default'] = function (styles) {
    ...
    _createClass(Menu, [{
      ...
      value: function handleExternalWrapper(id, wrapperStyles, set) {
        ...
        [html, body].forEach(function (element) {
          if (_this2.props.preventBodyScrollX) {
            element.style['overflow-x'] = set ? 'hidden' : '';
          }
          if (_this2.props.preventBodyScrollY) {
      ...
      value: function render() {
        ...
        return _react2['default'].createElement(
          ...
          !this.props.noOverlay && _react2['default'].createElement('div', {
            ...
            onClick: function () {
              return !_this4.shouldDisableOverlayClick() && _this4.toggleMenu();
            },
  ...
  Menu.propTypes = {
    ...
    preventBodyScrollX: _propTypes2['default'].bool,
    preventBodyScrollY: _propTypes2['default'].bool
  };

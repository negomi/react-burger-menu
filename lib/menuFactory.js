    ...
    render: function render() {
      ...
      if (styles.svg) {
        svg = _react2['default'].createElement(
          'div',
          { className: 'bm-morph-shape', style: [styles.morphShape(this.props.right), this.props.styles.bmMorphShape] },
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'div',
          { id: this.props.id, className: "bm-menu-wrap", style: menuWrapStyles.concat(this.props.styles.bmMenuWrap) },
          svg,
          _react2['default'].createElement(
            'div',
            { className: 'bm-menu', style: menuStyles.concat(this.props.styles.bmMenu) },
            _react2['default'].createElement(
              'nav',
              { className: 'bm-item-list', style: itemListStyles.concat(this.props.styles.bmItemList) },
              items
            )
          ),
          _react2['default'].createElement(
        ...
        _react2['default'].createElement(_BurgerIcon2['default'], { onClick: this.toggleMenu, styles: this.props.styles, image: this.props.customIcon })
      );
    }
  }));
};
